...
const ChatIcon = ({
  ...
  dotStrokeColor = 'white', // Color for the three dots
  dotStrokeWidth = 2,
}) => (
  <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
    ...
    {/* Main speech bubble path with gradient fill */}
    <Path
    ...
    />
    {/* Overlapping shape with gradient fill */}
    <Path
      ...
      strokeWidth={borderColor === 'none' ? 0 : strokeWidth}
    />
    {/* Three dots overlay with stroke */}
    <Path
      d="M13.49 13H13.5"
